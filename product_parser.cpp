...
{
    //instantiate new book product from information parsed
    Product* newBookProduct = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
...
{
    //instantiate new clothing product from information parsed
    Product* newClothingProduct = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
...
{
    //instantiate new movie product from information parsed
    Product* newMovieProduct = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
